<template>
    ...
    <div class="container">
        ...
        <div class="grid_12 gridnavigation">
            <!-- logo fade-up animate4 -->
            <img class="logo" alt="" src="/assets/img/dig.png" height="44px">
            <!--start navigation-->
            <span class="logo"
                style="margin-top: 1%;padding: 13px;font-weight: bold;color:#0090d3;font-style: italic;">DIG Travel &
                Tourism</span>
